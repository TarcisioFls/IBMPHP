    ...
    <body id="teste">
        ...
        <?php
            ...
            $queryAtualizar = "UPDATE usuario
                             ...
                             WHERE id ='$id'";
            $query4 = mysqli_query($conn, $queryAtualizar) or die(mysqli_error(""));
            ...
            if ($query4){
                ...
                echo "<div class='alert alert-error'>
                    <button type='button' class='close' data-dismiss='alert'>×</button>
                    <h4>Falha!</h4>
                    Cadastro não Realizado. Por favor repita o processo.
                    </div>";
            }
        ...
        <section class="container-fluid">
            ...
            <div class="panel panel-default">
                <table class="table-condensed">
                    <?php
                    $queryAtualizar2 = "SELECT * FROM usuario WHERE id ='$id'";

                        $result2 = mysqli_query($conn, $queryAtualizar2);
